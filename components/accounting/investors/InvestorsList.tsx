  ...
  if (isLoading) {
    return (
      <div className="bg-white rounded-2xl border border-secondary/[0.08] shadow-sm p-8">
        <div className="flex items-center justify-center gap-2 text-secondary/90">
    ...
    return (
      <div className="text-center py-16">
        <div className="w-12 h-12 rounded-2xl bg-secondary/[0.03] mx-auto mb-3 flex items-center justify-center">
          <Users className="w-6 h-6 text-secondary/80" />
        </div>
        <p className="text-secondary/90 font-dubai text-sm">{t.accounting.investors.noInvestors}</p>
        <p className="text-secondary/90 font-dubai text-xs mt-1">
            ...
            >
              ...
              <div className="flex-1 text-right">
                ...
                <div className="flex items-center gap-3 mt-0.5 flex-wrap">
                  {investor.email && (
                    <span className="flex items-center gap-1 text-xs text-secondary/90">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                {isExpanded ? (
                  <ChevronUp className="w-4 h-4 text-secondary/90" />
                ) : (
                  <ChevronDown className="w-4 h-4 text-secondary/90" />
                )}
              </div>
            </button>
            ...
            {isExpanded && (
              ...
              >
                ...
                {investor.investments.length === 0 ? (
                  <div className="py-6 text-center text-secondary/90 text-xs font-dubai">
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="bg-secondary/[0.02] border-b border-secondary/[0.06]">
                          <th className="text-right px-4 py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><Building2 size={12} />{t.accounting.common.apartment}</span></th>
                          <th className="text-right px-4 py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><Percent size={12} />{t.accounting.investors.percentageLabel}</span></th>
                          <th className="text-right px-4 py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><Target size={12} />{t.accounting.investors.yearlyTargetHeader}</span></th>
                          <th className="text-right px-4 py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><ArrowDownCircle size={12} />{t.accounting.investors.withdrawalsHeader}</span></th>
                          <th className="text-right px-4 py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><Settings size={12} />{t.accounting.investors.actionsHeader}</span></th>
                        </tr>
                      </thead>
                          ...
                          <tr key={inv.id} className="hover:bg-secondary/[0.02] transition-colors">
                            <td className="px-4 py-2.5">
                              <span className="flex items-center gap-1.5 font-medium text-secondary font-dubai text-xs">
                                <Building2 className="w-3 h-3 text-secondary/90" />
                                {inv.apartment.name}
                              </span>
                            </td>
                            <td className="px-4 py-2.5">
                            ...
                            <td className="px-4 py-2.5">
                              <span className="text-secondary/90 text-xs font-dubai">
                            ...
                            <td className="px-4 py-2.5">
                              <span className="text-secondary/95 text-xs font-dubai">
                            ...
                            <td className="px-4 py-2.5">
                              <div className="flex items-center gap-1">
                                <button
                                  ...
                                  className="p-1.5 rounded-lg hover:bg-secondary/5 text-secondary/90
                                ...
                                <button
                                  ...
                                  className="p-1.5 rounded-lg hover:bg-red-50 text-secondary/90
