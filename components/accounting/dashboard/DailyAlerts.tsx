  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-5 border-b border-secondary/[0.06]">
        ...
        {!isLoading && total > 0 && (
          <span className="text-xs bg-secondary/[0.04] text-secondary/90 px-2.5 py-1 rounded-full font-dubai font-bold">
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            {checkOuts.length > 0 && (
              <div>
                <div className="flex items-center gap-1.5 mb-2">
                  <LogOut size={14} className="text-secondary/90" />
                  <span className="text-xs font-bold text-secondary/90 font-dubai">
