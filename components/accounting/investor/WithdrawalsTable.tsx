  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="mr-auto bg-secondary/[0.04] text-secondary/90 text-xs font-bold px-2.5 py-1
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-secondary/[0.02] border-b border-secondary/[0.06]">
                <th className="text-right px-4 py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><DollarSign size={12} />{t.accounting.investorPortal.withdrawalAmount}</span></th>
                <th className="text-right px-4 py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><Calendar size={12} />{t.accounting.investorPortal.withdrawalDate}</span></th>
                <th className="text-right px-4 py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><Building2 size={12} />{t.accounting.investorPortal.withdrawalApartment}</span></th>
                <th className="text-right px-4 py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><MessageSquare size={12} />{t.accounting.investorPortal.withdrawalNotes}</span></th>
              </tr>
            </thead>
            <tbody className="divide-y divide-primary/10">
              {withdrawals.map((w, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span className="flex items-center gap-1 text-secondary/90 text-xs font-dubai">
                  ...
                  <td className="px-4 py-3">
                    {w.comments ? (
                      <span className="flex items-center gap-1 text-secondary/90 text-xs font-dubai max-w-[200px] truncate">
            ...
            <tfoot>
              <tr className="bg-secondary/[0.03] border-t border-secondary/[0.06]">
                ...
                <td colSpan={3} className="px-4 py-3 text-xs text-secondary/90 font-dubai">
