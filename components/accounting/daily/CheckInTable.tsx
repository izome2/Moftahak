          ...
          <table className="w-full text-sm">
            <thead className="sticky top-0 z-10">
              <tr className="bg-secondary/[0.02] border-b border-secondary/[0.06]">
                <th className="text-right px-2 sm:px-4 py-2 sm:py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><Building2 size={12} />{t.accounting.daily.apartment}</span></th>
                <th className="text-right px-2 sm:px-4 py-2 sm:py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><User size={12} />{t.accounting.daily.guest}</span></th>
                <th className="text-right px-2 sm:px-4 py-2 sm:py-3 text-[11px] text-secondary/90 font-medium font-dubai hidden md:table-cell"><span className="inline-flex items-center gap-1"><Phone size={12} />{t.accounting.daily.contact}</span></th>
                <th className="text-right px-2 sm:px-4 py-2 sm:py-3 text-[11px] text-secondary/90 font-medium font-dubai hidden sm:table-cell"><span className="inline-flex items-center gap-1"><Clock size={12} />{t.accounting.daily.arrival}</span></th>
                <th className="text-right px-2 sm:px-4 py-2 sm:py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><Moon size={12} />{t.accounting.daily.nights}</span></th>
                {canAssignSupervisor && (
                  <th className="text-right px-2 sm:px-4 py-2 sm:py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><UserCheck size={12} />{t.accounting.daily.receptionSupervisor}</span></th>
                )}
              </tr>
            </thead>
            <tbody>
                  ...
                  >
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-3">
                      <div className="flex items-center gap-1.5">
                        <Building2 className="w-3.5 h-3.5 text-secondary/90" />
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-3 hidden md:table-cell">
                      {row.clientPhone ? (
                        <a
                          ...
                          className="flex items-center gap-1 text-secondary/90 hover:text-secondary
                            transition-colors"
                        >
                        ...
                        <span className="text-secondary/90 text-xs">—</span>
                      )}
                    </td>
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-3 hidden sm:table-cell">
                      <div className="flex flex-col gap-0.5">
                        {row.arrivalTime && (
                          <span className="flex items-center gap-1 text-secondary/90 text-xs">
                    ...
                    {/* الليالي */}
                    <td className="px-2 sm:px-4 py-2 sm:py-3">
                      <span className="text-xs bg-secondary/[0.04] text-secondary/90 px-2 py-0.5
