          ...
          <table className="w-full text-sm">
            <thead className="sticky top-0 z-10">
              <tr className="bg-secondary/[0.02] border-b border-secondary/[0.06]">
                ...
                <th className="text-right px-2 sm:px-4 py-2 sm:py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><Calendar size={12} />{t.accounting.daily.departure}</span></th>
                {canAssignSupervisor && (
                  <th className="text-right px-2 sm:px-4 py-2 sm:py-3 text-[11px] text-secondary/90 font-medium font-dubai"><span className="inline-flex items-center gap-1"><UserCheck size={12} />{t.accounting.daily.deliverySupervisor}</span></th>
                )}
              </tr>
            </thead>
            <tbody>
