  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        dir={isRTL ? 'rtl' : 'ltr'}
      >
        <Calendar size={15} className="text-secondary/90 flex-shrink-0" />
        <span className={`flex-1 text-right ${!value ? 'text-secondary/80' : ''}`}>
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        dir={isRTL ? 'rtl' : 'ltr'}
      >
        <Clock size={15} className="text-secondary/90 flex-shrink-0" />
        <span className={`flex-1 text-right ${!value ? 'text-secondary/80' : ''}`}>
