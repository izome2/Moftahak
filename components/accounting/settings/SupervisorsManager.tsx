      ...
      {isLoading ? (
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 text-sm border border-secondary/[0.08] rounded-xl
                focus:outline-none focus:border-secondary/20 font-dubai placeholder:text-secondary/80"
            />
            <button
          ...
          {supervisors.length === 0 ? (
            <p className="text-xs text-secondary/90 font-dubai text-center py-4">{t.accounting.settings.supervisors.noSupervisors}</p>
          ) : (
