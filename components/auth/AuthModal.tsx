                ...
                <div className="p-8 md:p-12 lg:p-16">
                  ...
                  <div className="text-center mb-8">
                    <h2 className="text-3xl md:text-4xl font-bold text-secondary mb-2 font-dubai">
                      {mode === 'login' ? 'مرحباً بعودتك' : mode === 'register' ? 'إنشاء حساب جديد' : 'استعادة كلمة المرور'}
                    </h2>
                  ...
                  {/* Mode Switcher Tabs - Hidden for forgot-password */}
                  ...
                  {/* Social Login (placeholder for future implementation) - Hidden for forgot-password */}
                  {mode !== 'forgot-password' && (
                  ...
                  {/* Terms & Privacy - Hidden for forgot-password */}
                  {mode !== 'forgot-password' && (
