      ...
      >
        ...
        >
          <div className="absolute -top-8 -left-8 opacity-[0.05] pointer-events-none">
            <Sofa className="w-48 h-48 text-primary" strokeWidth={1} />
          </div>
            ...
            >
              ...
              >
                ...
                <div 
                  ...
                  style={{ boxShadow: SHADOWS.icon }}
                >
                  <Sofa className="w-12 h-12 text-primary" strokeWidth={1.5} />
                </div>
              </motion.div>
        ...
        {items.length > 0 && (
          ...
          >
            <div className="absolute -top-10 -left-10 opacity-10 pointer-events-none">
              <Sofa className="w-40 h-40 text-white" strokeWidth={1} />
            </div>
