...
export default function AuditLogPage() {
          ...
          <div className="bg-secondary/5 rounded-xl overflow-hidden">
            ...
            {[...changedKeys].map(key => (
              <div key={key} className="grid grid-cols-3 px-3 sm:px-4 py-2 border-t border-secondary/5 text-[11px] sm:text-xs">
                ...
                <span className="text-xs text-secondary/90 font-dubai" style={{ textDecoration: 'line-through', textDecorationColor: 'rgba(16,48,43,0.25)', textUnderlineOffset: '0px' }}>
  ...
  return (
    <div className="flex-1 flex flex-col gap-3" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      ...
      >
        <Filter size={18} className="text-secondary/90 hidden sm:block" />
        ...
        <div className="relative col-span-full sm:col-span-1 sm:max-w-xs">
          ...
          <input
            ...
            className="w-full pr-10 pl-4 py-2.5 bg-white border-2 border-primary/20 rounded-xl text-sm font-dubai text-secondary placeholder:text-secondary/90 focus:outline-none focus:border-primary/40 transition-colors"
          />
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-secondary/[0.02] border-b border-secondary/[0.06]">
                  <th className="text-right px-4 py-3 font-dubai font-medium text-secondary/90 whitespace-nowrap">
                            ...
                            >
                              <div style={{ overflow: 'hidden', minHeight: 0 }}>
                                <div className="border-t border-secondary/[0.06] bg-secondary/[0.02] px-4 py-4 sm:px-6 sm:py-5">
                                  ...
                                  {log.ipAddress && (
                                    <p className="mt-3 text-[10px] text-secondary/80 font-dubai">
      ...
      {loadingMore && (
        <div className="flex items-center justify-center py-4">
          ...
          <span className="mr-3 text-sm font-dubai text-secondary/90">{audit.loadingMore}</span>
        </div>
      )}
      {!hasMore && allLogs.length > 0 && (
        <p className="text-center text-xs text-secondary/80 font-dubai py-2">
